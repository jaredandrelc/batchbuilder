...
const commandLibrary = [
    ...
    // FLOW
    { id: 'if_start', name: 'IF (Start)', cat: 'Flow', icon: 'alt_route', desc: 'Start conditional block', isContainerStart: true, useCase: 'IF EXIST file.txt (...)', fields: [{label: 'Condition Type', type: 'select', options: ['EXIST', 'NOT EXIST', 'DEFINED', 'NOT DEFINED', 'EQU (==)', 'NEQ (!=)', 'Custom'], req: true}, {label: 'Target', type: 'text', req: true}, {label: 'Compare Value', type: 'text'}] },
    ...
    // FILE SYSTEM
    { id: 'cd', name: 'CD', cat: 'FileSystem', icon: 'folder_open', desc: 'Change directory', fields: [{label: 'Path', type: 'text'}] },
    { id: 'md', name: 'MKDIR', cat: 'FileSystem', icon: 'create_new_folder', desc: 'Create folder', fields: [{label: 'Folder Name', type: 'text', req: true}] },
    { id: 'rd', name: 'RMDIR', cat: 'FileSystem', icon: 'folder_delete', desc: 'Delete folder', fields: [{label: 'Folder', type: 'text', req: true}, {label: 'Quiet Mode', type: 'select', options: ['No', 'Yes (/Q/S)']}] },
    { id: 'del', name: 'DEL', cat: 'FileSystem', icon: 'delete', desc: 'Delete file', fields: [{label: 'File', type: 'text', req: true}, {label: 'Force', type: 'select', options: ['No', 'Yes (/F/Q)']}] },
    { id: 'ren', name: 'REN', cat: 'FileSystem', icon: 'edit', desc: 'Rename file or folder', fields: [{label: 'Old Name', type: 'text', req: true}, {label: 'New Name', type: 'text', req: true}] },
    { id: 'copy', name: 'COPY', cat: 'FileSystem', icon: 'content_copy', desc: 'Copy file', fields: [{label: 'Source', type: 'text', req: true}, {label: 'Dest', type: 'text', req: true}] },
    { id: 'move', name: 'MOVE', cat: 'FileSystem', icon: 'drive_file_move', desc: 'Move file', fields: [{label: 'Source', type: 'text', req: true}, {label: 'Dest', type: 'text', req: true}] },
    { id: 'robocopy', name: 'ROBOCOPY', cat: 'FileSystem', icon: 'copy_all', desc: 'Robust File Copy', fields: [{label: 'Source', type: 'text', req: true}, {label: 'Dest', type: 'text', req: true}, {label: 'Flags', type: 'text', placeholder: '/MIR'}] },
    ...
    { id: 'tree', name: 'TREE', cat: 'FileSystem', icon: 'account_tree', desc: 'Display dir tree', fields: [{label: 'Path', type: 'text'}] },
    ...
    // NETWORK
    { id: 'ipconfig', name: 'IPCONFIG', cat: 'Network', icon: 'wifi', desc: 'Network info', fields: [{label: 'Action', type: 'select', options: ['Show All (/all)', 'Release (/release)', 'Renew (/renew)', 'Flush DNS (/flushdns)']}] },
    ...
    { id: 'net_user', name: 'NET USER', cat: 'Network', icon: 'person', desc: 'Manage users', fields: [{label: 'Username', type: 'text'}, {label: 'Command', type: 'text'}] },
    { id: 'net_use', name: 'NET USE', cat: 'Network', icon: 'link', desc: 'Map drive', fields: [{label: 'Drive', type: 'text'}, {label: 'Path', type: 'text'}] },
    ...
    { id: 'pip_install', name: 'Pip Install', cat: 'Python', icon: 'download', desc: 'Install package', fields: [{label: 'Package', type: 'text', req: true}] },
    { id: 'pip_freeze', name: 'Pip Freeze', cat: 'Python', icon: 'list', desc: 'List packages', fields: [{label: 'Output File', type: 'text', placeholder: 'requirements.txt'}] },
    { id: 'pip_upgrade', name: 'Pip Upgrade', cat: 'Python', icon: 'upgrade', desc: 'Upgrade pip', fields: [] },
...
const presetLibrary = [
    { name: 'Keep Display On', desc: 'Prevent sleep loop', icon: 'light_mode', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Keep Awake']},
        {id: 'color', values: ['0A (Green)']},
        {id: 'echo', values: ['Press Ctrl+C to stop...']},
        {id: 'label', values: ['LOOP']},
        {id: 'timeout', values: ['60']},
        {id: 'goto', values: ['LOOP']}
    ]},
    { name: 'Full Network Reset', desc: 'Flush DNS, Reset IP & Winsock', icon: 'wifi_off', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Network Reset Tool']},
        {id: 'echo', values: ['Releasing IP...']},
        {id: 'ipconfig', values: ['Release (/release)']},
        {id: 'echo', values: ['Flushing DNS...']},
        {id: 'ipconfig', values: ['Flush DNS (/flushdns)']},
        {id: 'echo', values: ['Renewing IP...']},
        {id: 'ipconfig', values: ['Renew (/renew)']},
        {id: 'echo', values: ['Resetting Winsock...']},
        {id: 'custom_cmd', values: ['netsh winsock reset']},
        {id: 'custom_cmd', values: ['netsh int ip reset']},
        {id: 'echo', values: ['Done! Please restart your computer.']},
        {id: 'pause', values: []}
    ]},
    { name: 'Node Project Clean', desc: 'Delete node_modules & dist', icon: 'delete_sweep', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Node Cleanup']},
        {id: 'echo', values: ['Cleaning project...']},
        {id: 'if_start', values: ['EXIST', 'node_modules', '']},
        {id: 'rd', values: ['node_modules', 'Yes (/Q/S)']},
        {id: 'block_end', values: []},
        {id: 'if_start', values: ['EXIST', 'dist', '']},
        {id: 'rd', values: ['dist', 'Yes (/Q/S)']},
        {id: 'block_end', values: []},
        {id: 'echo', values: ['Cleanup Complete']},
        {id: 'pause', values: []}
    ]},
    { name: 'Python Quick Start', desc: 'Venv, Activate, Install', icon: 'rocket_launch', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Python Setup']},
        {id: 'echo', values: ['Creating virtual environment...']},
        {id: 'py_venv', values: ['venv']},
        {id: 'echo', values: ['Activating...']},
        {id: 'custom_cmd', values: ['call venv\\Scripts\\activate']},
        {id: 'echo', values: ['Installing dependencies...']},
        {id: 'pip_install', values: ['requests']},
        {id: 'pip_freeze', values: ['requirements.txt']},
        {id: 'echo', values: ['Environment Ready']}
    ]},
    { name: 'Organize Images', desc: 'Move jpg/png to folder', icon: 'perm_media', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Image Organizer']},
        {id: 'md', values: ['Images']},
        {id: 'move', values: ['*.jpg', 'Images']},
        {id: 'move', values: ['*.png', 'Images']},
        {id: 'echo', values: ['Images Moved']}
    ]},
    { name: 'Git Auto-Sync', desc: 'Pull, Add, Commit, Push', icon: 'cloud_sync', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Git Sync']},
        {id: 'echo', values: ['Pulling latest changes...']},
        {id: 'git_pull', values: []},
        {id: 'echo', values: ['Staging changes...']},
        {id: 'git_add', values: ['.']},
        {id: 'echo', values: ['Committing...']},
        {id: 'git_commit', values: ['Auto-sync']},
        {id: 'echo', values: ['Pushing...']},
        {id: 'git_push', values: []},
        {id: 'echo', values: ['Synced with remote']},
        {id: 'pause', values: []}
    ]},
    { name: 'Backup to Zip', desc: 'Archive Documents', icon: 'archive', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['Backup Tool']},
        {id: 'set_p', values: ['backupName', 'Enter backup name: ']},
        {id: 'echo', values: ['Archiving...']},
        {id: '7zip_create', values: ['%backupName%.7z', '*.txt *.docx *.pdf', '-mx9']},
        {id: 'echo', values: ['Backup created!']},
        {id: 'pause', values: []}
    ]},
    { name: 'System Report', desc: 'Export system info', icon: 'assignment', blocks: [
        {id: 'echo_off', values: []},
        {id: 'title', values: ['System Report']},
        {id: 'echo', values: ['Gathering system info...']},
        {id: 'custom_cmd', values: ['systeminfo > system_report.txt']},
        {id: 'echo', values: ['Gathering IP info...']},
        {id: 'custom_cmd', values: ['ipconfig /all >> system_report.txt']},
        {id: 'echo', values: ['Report saved to system_report.txt']},
        {id: 'pause', values: []}
    ]}
];